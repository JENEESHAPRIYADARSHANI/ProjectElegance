...
%>
 ...
 <%
// Check if the URL parameter indicates a successful or failed password reset
String resetStatus = request.getParameter("status");
if (resetStatus != null) {
    if (resetStatus.equals("resetSuccess")) {
%>
...
<%
} else if (resetStatus.equals("resetFailed")) {
%>
