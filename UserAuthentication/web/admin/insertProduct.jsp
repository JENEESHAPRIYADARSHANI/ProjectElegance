<%-- 
    ...
    Created on : May 1, 2024, 9:39:29 AM
    Author     : DELL
--%>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                ...
                                <a href="../DeleteProductServlet" class="dropdown-item">Delete Products</a>
                                <a href="tableView.jsp" class="dropdown-item">View Products</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-truck me-2"></i>Orders</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="../ViewOrderServlet" class="dropdown-item">Pending Orders</a>
                                <a href="index.jsp" class="dropdown-item">Cancel Orders</a>
                            </div>
                        </div>
                ...
                <div class=" rounded h-100 p-4">
                    ...
                    <form method="post" action="../AddProductServlet" enctype="multipart/form-data">
                        <div class="form-floating mb-3">
                            <input type="Text" class="form-control" id="itemName" placeholder="Item Code" name="itemCode">
                        ...
                        <div class="form-floating mb-3">
                            <input type="Text" class="form-control" id="stockAmount" placeholder="Stock Amount" name="stockAmount">
                            <label for="stockAmount">Stock Amount</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="Text" class="form-control" id="piece" placeholder="Price of one peice" name="piece" disabled value="1">
                            <label for="piece">piece</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="Text" class="form-control" id="price" placeholder="Price in Rs" name="price">
                            <label for="price">Price in Rs for 1 piece</label>
                        </div>

                        <div class="form-floating mb-3">
                            <select class="form-select" id="category" aria-label="Floating label select example" name="category">
                                <option value="acc" selected="acc">Accessories</option>
                    ...
                    <div class="bg-light rounded-top p-4">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 text-center text-sm-end">
                                ...
                                Designed By <a href="https://htmlcodex.com">Elegance Eco</a>
                                </br>
                                For <a class="border-bottom" href="https://themewagon.com" target="_blank">Elegance Eco</a>
                            </div>
                        </div>
                    </div>
                </div>
